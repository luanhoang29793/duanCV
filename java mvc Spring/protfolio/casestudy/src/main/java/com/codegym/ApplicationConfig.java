...
import com.codegym.repository.impl.ContactFormRepositoryImpl;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter
   ...
   public UserService userService(){
    ...
    @Bean
    public ContactServer contactServer(){return  new ContactServiceImpl();
    }
    @Bean
    public ContactRepository contactRepository(){
        return  new ContactFormRepositoryImpl();
    }
    //them anh
